"""
Django settings for cody_test_app_1 project.
...
ROOT_URLCONF = 'cody_test_app_1.urls'
...
WSGI_APPLICATION = 'cody_test_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cody_test_app_1 API",
    "DESCRIPTION": "API documentation for cody_test_app_1 App",
    "VERSION": "v1",
}
